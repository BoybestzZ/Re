 ...
 * @author 75496
 */
public class A800ColumnStoryDriftpercentagefunction3F {
    
        public static void main(String[] args) throws IOException, SQLException{
//           createShearForceColumnPercentage(EdefenseInfo.Column2FA3, "ew");

           createShearForceColumnPercentage(EdefenseInfo.Column3FA3, "ew");
//           createShearForceColumnPercentage(EdefenseInfo.Column3FA4, "ew");
//           createShearForceColumnPercentage(EdefenseInfo.Column3FB3, "ew");
//           createShearForceColumnPercentage(EdefenseInfo.Column3FB4, "ew");

           
           createShearForceColumnPercentage(EdefenseInfo.Column3FA3, "ns");
//           createShearForceColumnPercentage(EdefenseInfo.Column3FA4, "ns");
//           createShearForceColumnPercentage(EdefenseInfo.Column3FB3, "ns");
//           createShearForceColumnPercentage(EdefenseInfo.Column3FB4, "ns");
...
//                st2.executeUpdate(createTableQuery);
            ...
            for (int i = 0; i < kasins.length; i++) {
                ...
                // Execute query and get result set
                    ResultSet rs = st.executeQuery("SELECT TESTNAME, MAX(STORYDRIFT3F) AS STORYDRIFT3F, MAX(POSITIVE) AS POSITIVE, MAX(NEGATIVE) AS NEGATIVE FROM StoryDrift"+columnInfo.getName()+direction+" WHERE TESTNAME = '" +testName+ "' GROUP BY TESTNAME;");
                    rs.next();
...
//                    double shearnegative = negative/shearforce;
                    ...
                    double shearpositive = Math.abs(shearforce/positive);
                    double shearnegative = Math.abs(shearforce/negative);
...
//            ChartUtils.saveChartAsPNG(chartFile, chart, width, height);
              ...
              String filePath = "C:\\Users\\75496\\Documents\\E-Defense\\storydriftcolumn(f)\\sfp_"+columnInfo.getName()+direction+".svg";
...
//            // Display the chart in a frame
            ...
            Logger.getLogger(A800ColumnStoryDriftpercentagefunction3F.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
