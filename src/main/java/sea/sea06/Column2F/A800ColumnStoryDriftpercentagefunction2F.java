 ...
 * @author 75496
 */
public class A800ColumnStoryDriftpercentagefunction2F {
...
//                st2.executeUpdate(createTableQuery);
            ...
            for (int i = 0; i < kasins.length; i++) {
                ...
                // Execute query and get result set
                    ResultSet rs = st.executeQuery("SELECT TESTNAME, MAX(STORYDRIFT2F) AS STORYDRIFT2F, MAX(POSITIVE) AS POSITIVE, MAX(NEGATIVE) AS NEGATIVE FROM StoryDrift"+columnInfo.getName()+direction+" WHERE TESTNAME = '" +testName+ "' GROUP BY TESTNAME;");
                    rs.next();
...
//            // Display the chart in a frame
            ...
            Logger.getLogger(A800ColumnStoryDriftpercentagefunction2F.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
