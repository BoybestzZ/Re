 ...
 * @author 75496
 */
public class A800ColumnStoryDriftwithtimehistoryanalysisfunction2F {

    public static void main(String[] args) throws IOException, SQLException{
        
           createStoryDriftPercentage(EdefenseInfo.Column2FA3, "ew");
           createStoryDriftPercentage(EdefenseInfo.Column2FA4, "ew");
           createStoryDriftPercentage(EdefenseInfo.Column2FB3, "ew");
           createStoryDriftPercentage(EdefenseInfo.Column2FB4, "ew");

           createStoryDriftPercentage(EdefenseInfo.Column2FA3, "ns");
           createStoryDriftPercentage(EdefenseInfo.Column2FA4, "ns");
           createStoryDriftPercentage(EdefenseInfo.Column2FB3, "ns");
           createStoryDriftPercentage(EdefenseInfo.Column2FB4, "ns");
...
//            
            ...
            st.executeUpdate("CREATE TABLE IF NOT EXISTS StoryDrift"+columnInfo.getName()+direction+" (TestName VARCHAR(20), StoryDrift2F DOUBLE)");
            ...
            for (int i = 0; i < kasins.length; i++) {
                ...
                String insertQuery = "INSERT INTO StoryDrift"+columnInfo.getName()+direction+" (TestName, StoryDrift2F) VALUES ('" + testName + "', " + storyDrift2F + ")";
            ...
            for (int i = 0; i < kasins2.length; i++) {
                ...
                ResultSet rs08 = st08.executeQuery("SELECT \"2ndStoryDrift[mm]\" FROM \"B230ElementShearLocalStiffness\" where TESTNAME = '" + testName + "' and \"ElementName\" = '"+columnName+"' and \"PositiveDirection\" = TRUE and Direction = '"+direction+"';");
                rs08.next();
...
//                String insertQuery = "INSERT INTO StoryDrift"+columnInfo.getName()+direction+" (TestName, positive) VALUES ('" + testName + "'," + storyDrift2Fpostive + ")";
                String insertQuery = "UPDATE StoryDrift"+columnInfo.getName()+direction+" SET POSITIVE="+storyDrift2Fpostive+" where TESTNAME='"+testName+"'"; //, positive) VALUES ('" + testName + "'," + shearforcestiffnesspositive + ")";
                st.executeUpdate(insertQuery);
                System.out.println("Record for TestName '" + testName + "' inserted into the table.");
           ...
           // Create table to store results if it doesn't exist
            ...
            for (int i = 0; i < kasins3.length; i++) {
                ...
                ResultSet rs08 = st08.executeQuery("SELECT \"2ndStoryDrift[mm]\" FROM \"B230ElementShearLocalStiffness\" where TESTNAME = '" + testName + "' and \"ElementName\" = '"+columnName+"' and \"PositiveDirection\" = FALSE and Direction = '"+direction+"';");
                rs08.next();
                
                                // get results
                double storyDrift2Fnegative = rs08.getDouble(1);
                
//                String insertQuery = "INSERT INTO StoryDrift"+columnInfo.getName()+direction+" (TestName, negative) VALUES ('" + testName + "'," + storyDrift2Fnegative + ")";
                String insertQuery = "UPDATE StoryDrift"+columnInfo.getName()+direction+" SET NEGATIVE="+storyDrift2Fnegative+" where TESTNAME='"+testName+"'"; //, positive) VALUES ('" + testName + "'," + shearforcestiffnesspositive + ")";
                st.executeUpdate(insertQuery);
                System.out.println("Record for TestName '" + testName + "' inserted into the table.");
...
//            // Display the chart in a frame
            ...
            Logger.getLogger(A800ColumnStoryDriftwithtimehistoryanalysisfunction2F.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
