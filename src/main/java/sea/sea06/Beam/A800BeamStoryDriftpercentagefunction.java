...
import sea.sea04.Beamshearforce.*;
 ...
 * @author 75496
 */
public class A800BeamStoryDriftpercentagefunction {
    
        public static void main(String[] args) throws IOException, SQLException{
           createStoryDriftBeamPercentage34A(EdefenseInfo.Beam3, 0);
           createStoryDriftBeamPercentage34A(EdefenseInfo.Beam4, 0);
           createStoryDriftBeamPercentage34A(EdefenseInfo.BeamA, 0);
           createStoryDriftBeamPercentage34A(EdefenseInfo.BeamB, 0);
//           createShearForceBeamTable(EdefenseInfo.BeamB);

    }

    public static void createStoryDriftBeamPercentage34A(BeamInfo beamInfo, int section) throws IOException, SQLException {
...
//                st2.executeUpdate(createTableQuery);
            ...
            for (int i = 0; i < kasins.length; i++) {
                ...
                // Execute query and get result set
                    ResultSet rs = st.executeQuery("SELECT TESTNAME, MAX(STORYDRIFT2F) AS STORYDRIFT2F, MAX(POSITIVE) AS POSITIVE, MAX(NEGATIVE) AS NEGATIVE FROM StoryDrift"+sectionNB+" WHERE TESTNAME = '" +testName+ "' GROUP BY TESTNAME;");
                    rs.next();
...
//            ChartUtils.saveChartAsPNG(chartFile, chart, width, height);
              ...
              String filePath = "C:\\Users\\75496\\Documents\\E-Defense\\storydrift(f)\\sd_"+beamName+".svg";
...
//            // Display the chart in a frame
            ...
            Logger.getLogger(A800BeamStoryDriftpercentagefunction.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
