...
public class Combined2ResidualStrainGraphFreq{ 

        public static void main(String[] args) throws IOException, SQLException{
        
        createResidualStrain("RSb02/01", "RSb02/05", "fourierb215");
        createResidualStrain("RSb02/02", "RSb02/06", "fourierb226");
        createResidualStrain("RSb02/03", "RSb02/07", "fourierb237");
        createResidualStrain("RSb02/04", "RSb02/08", "fourierb248");
        
        createResidualStrain("RSb03/01", "RSb03/05", "fourierb315");
        createResidualStrain("RSb03/02", "RSb03/06", "fourierb326");
        createResidualStrain("RSb03/03", "RSb03/07", "fourierb337");
        createResidualStrain("RSb03/04", "RSb03/08", "fourierb348");
        
        createResidualStrain("RSf02/01", "RSf02/05", "fourierf215");
        createResidualStrain("RSf02/02", "RSf02/06", "fourierf226");
        createResidualStrain("RSf02/03", "RSf02/07", "fourierf237");
        createResidualStrain("RSf02/04", "RSf02/08", "fourierf248");
        
        createResidualStrain("RSf01/01", "RSf01/05", "fourierf115");
        createResidualStrain("RSf01/02", "RSf01/06", "fourierf126");
        createResidualStrain("RSf01/03", "RSf01/07", "fourierf137");
        createResidualStrain("RSf01/04", "RSf01/08", "fourierf148");
        
        createResidualStrain("RSh02/01", "RSh02/05", "fourierh215");
        createResidualStrain("RSh02/02", "RSh02/06", "fourierh226");
        createResidualStrain("RSh02/03", "RSh02/07", "fourierh237");
        createResidualStrain("RSh02/04", "RSh02/08", "fourierh248");
        
        
        createResidualStrain("RSh03/01", "RSh03/05", "fourierh315");
        createResidualStrain("RSh03/02", "RSh03/06", "fourierh326");
        createResidualStrain("RSh03/03", "RSh03/07", "fourierh337");
        createResidualStrain("RSh03/04", "RSh03/08", "fourierh348");
        
        
        createResidualStrain("RSd03/01", "RSd03/05", "fourierd315");
        createResidualStrain("RSd03/02", "RSd03/06", "fourierd326");
        createResidualStrain("RSd03/03", "RSd03/07", "fourierd337");
        createResidualStrain("RSd03/04", "RSd03/08", "fourierd348");
        
        createResidualStrain("RSd02/01", "RSd02/05", "fourierd215");
        createResidualStrain("RSd02/02", "RSd02/06", "fourierd226");
        createResidualStrain("RSd02/03", "RSd02/07", "fourierd237");
        createResidualStrain("RSd02/04", "RSd02/08", "fourierd248");
...
//        createResidualStrain("RSb03/01", "RSb03/02", "RSb03/03", "RSb03/04", "fourierb31234");
//        createResidualStrain("RSb03/05", "RSb03/06", "RSb03/07", "RSb03/08", "fourierb35678");
//        createResidualStrain("RSd02/01", "RSd02/02", "RSd02/03", "RSd02/04", "fourierd21234");
//        createResidualStrain("RSd02/05", "RSd02/06", "RSd02/07", "RSd02/08", "fourierd25678");
//        createResidualStrain("RSd03/01", "RSd03/02", "RSd03/03", "RSd03/04", "fourierd31234");
//        createResidualStrain("RSd03/05", "RSd03/06", "RSd03/07", "RSd03/08", "fourierd35678");
...
//        createResidualStrain("RSh03/05", "RSh03/06", "RSh03/07", "RSh03/08", "fourierh35678");
...
//            dataset.addSeries(table8, data8);
            ...
            rangeAxis.setRange(-20000, 20000); // Set the y-axis range
