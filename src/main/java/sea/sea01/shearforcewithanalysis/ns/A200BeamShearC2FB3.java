 ...
 * @author 75496
 */
public class A200BeamShearC2FB3 {
...
//            
            ...
            for (int i = 0; i < kasins.length; i++) {
                blackLine.add(i + 1, 4.359);
            }

            // Create table to store results if it doesn't exist
            st.executeUpdate("CREATE TABLE IF NOT EXISTS ShearForceResultsC2FB3nsJ (TestName VARCHAR(20), ShearForce DOUBLE)");
            ...
            for (int i = 0; i < kasins.length; i++) {
                ...
                String insertQuery = "INSERT INTO ShearForceResultsC2FB3nsJ (TestName, ShearForce) VALUES ('" + testName + "', " + shearForceComplex.getReal() + ")";
...
//            ChartUtils.saveChartAsPNG(chartFile, chart, width, height);
              ...
              String filePath = "C:\\Users\\75496\\Documents\\E-Defense\\sea02\\sf_C2FB3nswithanalysis.svg";
...
//            // Display the chart in a frame
            ...
            Logger.getLogger(A200BeamShearC2FB3.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
