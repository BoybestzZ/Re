...
//            
            ...
            for (int i = 0; i < kasins.length; i++) {
                blackLine.add(i + 1, 4.804);
            }

            // Create table to store results if it doesn't exist
            st.executeUpdate("CREATE TABLE IF NOT EXISTS ShearForceResultsC3FA3nsJ (TestName VARCHAR(20), ShearForce DOUBLE)");
            ...
            for (int i = 0; i < kasins.length; i++) {
                ...
                String insertQuery = "INSERT INTO ShearForceResultsC3FA3nsJ (TestName, ShearForce) VALUES ('" + testName + "', " + shearForceComplex.getReal() + ")";
...
//            ChartUtils.saveChartAsPNG(chartFile, chart, width, height);
              ...
              String filePath = "C:\\Users\\75496\\Documents\\E-Defense\\sea02\\sf_C3FA3nswithanalysis.svg";
