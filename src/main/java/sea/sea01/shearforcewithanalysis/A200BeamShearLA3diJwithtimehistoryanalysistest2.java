 ...
 * @author 75496
 */
public class A200BeamShearLA3diJwithtimehistoryanalysistest2 {
...
//            }
            ...
            st.executeUpdate("DROP TABLE IF EXISTS ShearForceResultsC2FA3ew");
...
//
            ...
            // Create table to store results if it doesn't exist
            st.executeUpdate("Alter table ShearForceResultsC2FA3ew add positive double;");
                ...
                String insertQuery2 = "INSERT INTO ShearForceResultsC2FA3ew (TestName, positive) VALUES ('" + testName + "'," + shearforcestiffnesspositive + ")";
                st08.executeUpdate(insertQuery2);
                System.out.println("Record for TestName '" + testName + "' inserted into the table.");
                ...
                dataset.addSeries("kobe+", kobep.toArray());
                            ...
                            // Create table to store results if it doesn't exist
            st.executeUpdate("Alter table ShearForceResultsC2FA3ew add negative double;");
                
                
                    ResultSet rs09 = st08.executeQuery("SELECT \"LocalStiffness[kN/mm]\" FROM \"B230ElementShearLocalStiffness\" where TESTNAME = '" + testName + "' and \"ElementName\" = 'Beam3' and \"PositiveDirection\" = FALSE;");
                    rs09.next();
                    

                    // get results
                    double shearforcestiffnessnegative = rs09.getDouble(1);
                    
                String insertQuery3 = "INSERT INTO ShearForceResultsC2FA3ew (TestName, negative) VALUES ('" + testName + "'," + shearforcestiffnessnegative + ")";
...
//            // Display the chart in a frame
            ...
            Logger.getLogger(A200BeamShearLA3diJwithtimehistoryanalysistest2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
