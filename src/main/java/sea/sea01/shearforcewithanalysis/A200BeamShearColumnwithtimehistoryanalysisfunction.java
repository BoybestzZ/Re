 ...
 * @author 75496
 */
public class A200BeamShearColumnwithtimehistoryanalysisfunction {
    ...
    public static void main(String[] args) throws IOException, SQLException{
        ...
        double distance = 1.15; // distance between Section 2 and Section 4;
           ...
           createShearForceColumnTable(EdefenseInfo.Column2FA3, distance, "ew");
    }

    public static void createShearForceColumnTable(ColumnInfo columnInfo, double distance, String direction) throws IOException, SQLException {
...
//            // Display the chart in a frame
            ...
            Logger.getLogger(A200BeamShearColumnwithtimehistoryanalysisfunction.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
