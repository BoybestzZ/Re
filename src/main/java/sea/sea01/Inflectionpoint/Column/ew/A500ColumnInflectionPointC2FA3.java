 ...
 * @author 75496
 */
public class A500ColumnInflectionPointC2FA3 {
...
//            
            ...
            for (int i = 0; i < kasins.length; i++) {
                ...
                // Execute query and get result set
                    ResultSet rs = st.executeQuery("SELECT \"INFLECTIONPOINT\" FROM \"COLUMNINFLECTIONPOINTDATA\" where TESTNAME='" + testName + "' and COLUMNNAME='Column2F3Aew';");
                    rs.next();
...
//            ChartUtils.saveChartAsPNG(chartFile, chart, width, height);
              ...
              String filePath = "C:\\Users\\75496\\Documents\\E-Defense\\Inflectionpoint\\ip_C2F3Aew.svg";
            ...
            Logger.getLogger(A500ColumnInflectionPointC2FA3.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
