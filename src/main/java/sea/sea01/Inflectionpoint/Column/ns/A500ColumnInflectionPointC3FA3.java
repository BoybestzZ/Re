 ...
 * @author 75496
 */
public class A500ColumnInflectionPointC3FA3 {
...
//            
            ...
            for (int i = 0; i < kasins.length; i++) {
                ...
                // Execute query and get result set
                    ResultSet rs = st.executeQuery("SELECT \"INFLECTIONPOINT\" FROM \"COLUMNINFLECTIONPOINTDATA\" where TESTNAME='" + testName + "' and COLUMNNAME='Column3F3Ans';");
                    rs.next();
...
//            ChartUtils.saveChartAsPNG(chartFile, chart, width, height);
              ...
              String filePath = "C:\\Users\\75496\\Documents\\E-Defense\\Inflectionpoint\\ip_C3F3Ans.svg";
            ...
            Logger.getLogger(A500ColumnInflectionPointC3FA3.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
