 ...
 */
package sea.sea01.Inflectionpoint.Column.ns;

import sea.sea01.Inflectionpoint.Column.ew.*;
 ...
 * @author 75496
 */
public class A500ColumnInflectionPointC2FB4 {
...
//            
            ...
            for (int i = 0; i < kasins.length; i++) {
                ...
                // Execute query and get result set
                    ResultSet rs = st.executeQuery("SELECT \"INFLECTIONPOINT\" FROM \"COLUMNINFLECTIONPOINTDATA\" where TESTNAME='" + testName + "' and COLUMNNAME='Column2F4Bns';");
                    rs.next();
...
//            ChartUtils.saveChartAsPNG(chartFile, chart, width, height);
              ...
              String filePath = "C:\\Users\\75496\\Documents\\E-Defense\\Inflectionpoint\\ip_C2F4Bns.svg";
            ...
            Logger.getLogger(A500ColumnInflectionPointC2FB4.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
