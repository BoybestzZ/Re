 ...
 * @author 75496
 */
public class A500BeamInflectionPointLA3withtimehistoryanalysis {
...
//            
            ...
            st.executeUpdate("DROP TABLE IF EXISTS InflPoi3");
            st.executeUpdate("CREATE TABLE IF NOT EXISTS InflPoi3 (TestName VARCHAR(20), Inflectionpoint DOUBLE)");
            ...
            for (int i = 0; i < kasins.length; i++) {
                ...
                String insertQuery = "INSERT INTO InflPoi3 (TestName, Inflectionpoint) VALUES ('" + testName + "', " + inflectionPoint + ")";
            ...
            // Create table to store results if it doesn't exist
            st.executeUpdate("Alter table InflPoi3 add positive double;");
            
            for (int i = 0; i < kasins2.length; i++) {
                String testName = kasins2[i].getTestName();  //D01Q01
                String waveName = kasins2[i].getWaveName();  // Random
                
                ResultSet rs08 = st08.executeQuery("SELECT \"InflectionPoint[m]\" FROM \"T122BeamInflectionPoint\" where TESTNAME = '" + testName + "t' and \"BEAMNAME\" = 'Beam3' and \"DIRECTION\" = 'POSITIVE';");
                rs08.next();
                ...
                String insertQuery = "INSERT INTO InflPoi3 (TestName, positive) VALUES ('" + testName + "'," + shearforcestiffnesspositive + ")";
                st.executeUpdate(insertQuery);
                System.out.println("Record for TestName '" + testName + "' inserted into the table.");
            ...
            // Create table to store results if it doesn't exist
            st.executeUpdate("Alter table InflPoi3 add negative double;");
            ...
            for (int i = 0; i < kasins3.length; i++) {
                ...
                ResultSet rs08 = st08.executeQuery("SELECT \"InflectionPoint[m]\" FROM \"T122BeamInflectionPoint\" where TESTNAME = '" + testName + "t' and \"BEAMNAME\" = 'Beam3' and \"DIRECTION\" = 'NEGATIVE';");
                rs08.next();
                ...
                String insertQuery = "INSERT INTO InflPoi3 (TestName, negative) VALUES ('" + testName + "'," + shearforcestiffnessnegative + ")";
                st.executeUpdate(insertQuery);
                System.out.println("Record for TestName '" + testName + "' inserted into the table.");
...
//            ChartUtils.saveChartAsPNG(chartFile, chart, width, height);
              ...
              String filePath = "C:\\Users\\75496\\Documents\\E-Defense\\Inflectionpoint\\ip_LA3.svg";
            ...
            Logger.getLogger(A500BeamInflectionPointLA3withtimehistoryanalysis.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
