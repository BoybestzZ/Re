 ...
 * @author 75496
 */
public class A500BeamInflectionPointLAB {
...
//            
            ...
            for (int i = 0; i < kasins.length; i++) {
                ...
                // Execute query and get result set
                    ResultSet rs = st.executeQuery("SELECT \"INFLECTIONPOINT\" FROM \"INFLECTIONPOINTDATA\" where TESTNAME='" + testName + "' and BEAMNAME='BeamB';");
                    rs.next();
...
//            ChartUtils.saveChartAsPNG(chartFile, chart, width, height);
              ...
              String filePath = "C:\\Users\\75496\\Documents\\E-Defense\\Inflectionpoint\\ip_LAB.svg";
            ...
            Logger.getLogger(A500BeamInflectionPointLAB.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
