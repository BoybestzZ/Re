 ...
 * @author 75496
 */
public class A500BeamInflectionPointLA4 {
...
//            
            ...
            for (int i = 0; i < kasins.length; i++) {
                ...
                // Execute query and get result set
                    ResultSet rs = st.executeQuery("SELECT \"INFLECTIONPOINT\" FROM \"INFLECTIONPOINTDATA\" where TESTNAME='" + testName + "' and BEAMNAME='Beam4';");
                    rs.next();
...
//            ChartUtils.saveChartAsPNG(chartFile, chart, width, height);
              ...
              String filePath = "C:\\Users\\75496\\Documents\\E-Defense\\Inflectionpoint\\ip_LA4.svg";
            ...
            Logger.getLogger(A500BeamInflectionPointLA4.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
