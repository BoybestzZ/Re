 ...
 */
package sea.sea04.Columnshearforce.Columnshearforcefreqonly;

import sea.sea04.Columnshearforce.*;
 ...
 * @author 75496
 */
public class A300ColumnShearwithtimehistoryanalysisfunction1 {
...
//
            ...
            rangeAxis.setRange(0, 18); // Set the y-axis range
...
//            plot.getRenderer(1).setSeriesStroke(0, new BasicStroke(2));
            ...
            XYTitleAnnotation ta=new XYTitleAnnotation(0.85 ,0.05, legend, RectangleAnchor.BOTTOM_RIGHT);
...
//            ChartUtils.saveChartAsPNG(chartFile, chart, width, height);
              ...
              String filePath = "C:\\Users\\75496\\Documents\\E-Defense\\shearlocalstiffnesscolumn(freqonly)\\sf_"+columnInfo.getName()+direction+".svg";
...
//            // Display the chart in a frame
            ...
            Logger.getLogger(A300ColumnShearwithtimehistoryanalysisfunction1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
