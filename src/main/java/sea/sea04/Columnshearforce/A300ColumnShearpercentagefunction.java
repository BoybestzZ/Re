 ...
 * @author 75496
 */
public class A300ColumnShearpercentagefunction {
    
        public static void main(String[] args) throws IOException, SQLException{
//           createShearForceColumnPercentage(EdefenseInfo.Column2FA3, "ew");

           createShearForceColumnPercentage(EdefenseInfo.Column2FA3, "ew");
           createShearForceColumnPercentage(EdefenseInfo.Column2FA4, "ew");
           createShearForceColumnPercentage(EdefenseInfo.Column2FB3, "ew");
           createShearForceColumnPercentage(EdefenseInfo.Column2FB4, "ew");
           ...
           createShearForceColumnPercentage(EdefenseInfo.Column2FA3, "ns");
           createShearForceColumnPercentage(EdefenseInfo.Column2FA4, "ns");
           createShearForceColumnPercentage(EdefenseInfo.Column2FB3, "ns");
           createShearForceColumnPercentage(EdefenseInfo.Column2FB4, "ns");
...
//            // Display the chart in a frame
            ...
            Logger.getLogger(A300ColumnShearpercentagefunction.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
