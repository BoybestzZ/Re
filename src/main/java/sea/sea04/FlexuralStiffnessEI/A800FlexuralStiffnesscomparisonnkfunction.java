 ...
 */
package sea.sea04.FlexuralStiffnessEI;
 ...
 * @author 75496
 */
public class A800FlexuralStiffnesscomparisonnkfunction {
    ...
    public static void main(String[] args) throws IOException, SQLException{
        ...
        double section1 = 0.23;    //distance from centroid of concrete and beam
        double section2 = 0.177;    //distance from centroid of concrete and beam
        ...
        double EIs2 = 12028223.57;         // beamB only unit: Nm2 (steel only)
           ...
           createFlexuralStiffnessGraph(EdefenseInfo.Beam3, distance1, section1, 3, EIs);
           createFlexuralStiffnessGraph(EdefenseInfo.Beam3, distance1, section1, 4, EIs);
           
           createFlexuralStiffnessGraph(EdefenseInfo.Beam4, distance1, section1, 0, EIs);
           createFlexuralStiffnessGraph(EdefenseInfo.Beam4, distance1, section1, 1, EIs);
           createFlexuralStiffnessGraph(EdefenseInfo.Beam4, distance1, section1, 2, EIs);
           createFlexuralStiffnessGraph(EdefenseInfo.Beam4, distance1, section1, 3, EIs);
           createFlexuralStiffnessGraph(EdefenseInfo.Beam4, distance1, section1, 4, EIs);
           
           createFlexuralStiffnessGraph(EdefenseInfo.BeamA, distance1, section1, 0, EIs);
           createFlexuralStiffnessGraph(EdefenseInfo.BeamA, distance1, section1, 1, EIs);
           createFlexuralStiffnessGraph(EdefenseInfo.BeamA, distance1, section1, 2, EIs);
           createFlexuralStiffnessGraph(EdefenseInfo.BeamA, distance1, section1, 3, EIs);
           createFlexuralStiffnessGraph(EdefenseInfo.BeamA, distance1, section1, 4, EIs);
           
           createFlexuralStiffnessGraph(EdefenseInfo.BeamB, distance2, section2, 0, EIs2);
           createFlexuralStiffnessGraph(EdefenseInfo.BeamB, distance2, section2, 1, EIs2);
           createFlexuralStiffnessGraph(EdefenseInfo.BeamB, distance2, section2, 2, EIs2);
           createFlexuralStiffnessGraph(EdefenseInfo.BeamB, distance2, section2, 3, EIs2);
           createFlexuralStiffnessGraph(EdefenseInfo.BeamB, distance2, section2, 4, EIs2);
...
//            // Display the chart in a frame
            ...
            Logger.getLogger(A800FlexuralStiffnesscomparisonnkfunction.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
