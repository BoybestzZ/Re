 ...
 * @author 75496
 */
public class A500BeamInflectionPointpercentagefunction {

            public static void main(String[] args) throws IOException, SQLException{
           createInflectionPointPercentage(EdefenseInfo.Beam3);
           createInflectionPointPercentage(EdefenseInfo.Beam4);
           createInflectionPointPercentage(EdefenseInfo.BeamA);
           createInflectionPointPercentage(EdefenseInfo.BeamB);
...
//            rangeAxis.setInverted(true);
            ...
            XYTitleAnnotation ta=new XYTitleAnnotation(0.9 ,0.05, legend, RectangleAnchor.BOTTOM_RIGHT);
...
//            ChartUtils.saveChartAsPNG(chartFile, chart, width, height);
              ...
              String filePath = "C:\\Users\\75496\\Documents\\E-Defense\\Inflectionpoint(f)\\ip%_"+beamName+".svg";
...
//            // Display the chart in a frame
            ...
            Logger.getLogger(A500BeamInflectionPointpercentagefunction.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
