 ...
 * @author 75496
 */
public class A600FrequencydiC3FA3 {
...
//            st.executeUpdate("CREATE TABLE IF NOT EXISTS FrequencyLA3 (TestName VARCHAR(20), ShearForce DOUBLE)");
            ...
            for (int i = 0; i < kasins.length; i++) {
                ...
                // Execute query and get result set
                    ResultSet rs = st.executeQuery("SELECT \"Freq[Hz]\" FROM \"A310SectionNM\" WHERE TESTNAME = '" + testName + "' and SECTION = 'CS3FA3Tns';");
                    rs.next();
...
//            ChartUtils.saveChartAsPNG(chartFile, chart, width, height);
              ...
              String filePath = "C:\\Users\\75496\\Documents\\E-Defense\\frequency\\fre_C3FA3ns.svg";
...
//            // Display the chart in a frame
            ...
            Logger.getLogger(A600FrequencydiC3FA3.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
