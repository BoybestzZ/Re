 ...
 * @author 75496
 */
public class A200ShearForceBeam3timehistorywithfrequencyfunction {
    
        public static void main(String[] args) throws IOException, SQLException{
           createShearForceBeamPercentage34A(EdefenseInfo.Beam3);
           createShearForceBeamPercentage34A(EdefenseInfo.Beam4);
           createShearForceBeamPercentage34A(EdefenseInfo.BeamA);
           createShearForceBeamPercentage34A(EdefenseInfo.BeamB);
//           createShearForceBeamTable(EdefenseInfo.BeamB);

    }

    public static void createShearForceBeamPercentage34A(BeamInfo beamInfo) throws IOException, SQLException {
...
//            // Display the chart in a frame
            ...
            Logger.getLogger(A200ShearForceBeam3timehistorywithfrequencyfunction.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
