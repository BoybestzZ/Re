 ...
 * @author 75496
 */
public class A500InflectionPointBeam3timehistorywithfrequency {
...
//                st2.executeUpdate(createTableQuery);
            ...
            for (int i = 0; i < kasins.length; i++) {
                ...
                // Execute query and get result set
                    ResultSet rs = st.executeQuery("SELECT TESTNAME, MAX(Inflectionpoint) AS Inflectionpoint, MAX(POSITIVE) AS POSITIVE, MAX(NEGATIVE) AS NEGATIVE FROM InflPoi3 WHERE TESTNAME = '" +testName+ "' GROUP BY TESTNAME;");
                    rs.next();
...
//            // Display the chart in a frame
            ...
            Logger.getLogger(A500InflectionPointBeam3timehistorywithfrequency.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
