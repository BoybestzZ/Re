...
//            
            ...
            st.executeUpdate("DROP TABLE IF EXISTS phi3S5");
            st.executeUpdate("CREATE TABLE IF NOT EXISTS phi3S5 (TestName VARCHAR(20), phi DOUBLE)");
            ...
            for (int i = 0; i < kasins.length; i++) {
                ...
                String insertQuery = "INSERT INTO phi3S5 (TestName, phi) VALUES ('" + testName + "', " + phi2 + ")";
