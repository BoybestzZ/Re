...
/**
 * T282→ T283 : Lower じゃなくて Uppwerのグラフを描く。
 * T280 → T281 : T270から最大時刻のものを取り出す。T280よりも多くの情報が出力される。
 *
 * @author jun
 *
 */
public class T283GraphUpperFlangeLateralMomentRatio {

    public static void main(String[] args) {
        try {
            Path svgdir = Path.of("/home/jun/Dropbox (SSLUoT)/res23/ed/ed06分析T/T283UpperFlangeLateralMomentRatio");
            ...
            for (String[] tt : types) {
                ...
                while (rs.next()) {
                    double upperRatio = rs.getDouble(5);
            ...
            if (svgdir != null) {
                ...
                try {
                    ...
                    Logger.getLogger(T283GraphUpperFlangeLateralMomentRatio.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
