 ...
 * @author jun
 */
public class R161GraphStoryDriftS {
...
//            main(databaseDir, "D03Q09",       "R151FourierR");
            ...
            Logger.getLogger(R161GraphStoryDriftS.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private static void main(Path databaseDir, String testname, String tablename) throws SQLException {
        ...
        // basephase
        double[] basephaseY = readBasePhase(con, "R152FourierS", "b03/01", "Phase[rad]");
        double[] basephaseX = readBasePhase(con, "R152FourierS", "h02/01", "Phase[rad]");
